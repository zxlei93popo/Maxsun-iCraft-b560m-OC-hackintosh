...
!   2.Intel AX 系列(例如 AX200)
!   3.Intel AC 系列(例如 9260ac 3160ac)
...
```
![选择安装硬盘](./APPLE/Diskpartition/3.png)
```
...
![选择 platform-id](./APPLE/Patch/1.png)
```
            4.选择 'Patch'(在连接核显后)
...
**解压密码: heipg.cn**
```
      2.定位到独显路径(例如 PCI(0x0)/PCI(0x1a,0x1))
```
